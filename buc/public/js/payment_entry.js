frappe.ui.form.on("Payment Entry", {
    ...
    refresh: function (frm) {
        ...
        frm.fields_dict["deductions"].grid.get_field("division").get_query = function(doc, cdt, cdn) {
            let row = locals[cdt][cdn];
            return {
                filters: [
                    ["department", "=", row.department],
        ...
        frm.fields_dict["deductions"].grid.get_field("business_unit").get_query = function(doc, cdt, cdn) {
            let row = locals[cdt][cdn];
            return {
                filters: [
                    ["division", "=", row.division],
...
frappe.ui.form.on("Payment Deductions or Loss", {
